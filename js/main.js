...
MetronicApp.controller('AppController', ['$scope', '$rootScope', 'CheckAdmin', function($scope, $rootScope, CheckAdmin) {
    $scope.$on('$viewContentLoaded', function() {
        App.initComponents(); // init core components
        //Layout.init(); //  Init entire layout(header, footer, sidebar, etc) on page load if the partials included in server side instead of loading with ng-include directive 
    });

    // $scope.validAdmin = CheckAdmin.isValid();

    $scope.validAdmin = function()
    {
        // $scope.userName =localStorage['adminName'];
        return CheckAdmin.isValid();
    }
...
MetronicApp.controller('HeaderController', ['$scope','Notification','$state','$rootScope','$http', 'CheckAdmin', '$modal', function($scope,Notification,$state, $rootScope, $http, CheckAdmin, $modal) {
    $scope.$on('$includeContentLoaded', function() {
        Layout.initHeader(); // init header
    });

    // $scope.CheckAdmin = CheckAdmin.isValid();
...
$scope.logoutConfirm = function()
{
    $scope.opts = {
                                ...
                                keyboard: true,
                                scope: $scope,
                                templateUrl: 'views/confirmLogoutPop.html',
                                controller: function($scope, $modalInstance, $modal, $http) 
                                {
                                    $scope.ok = function () 
                                    {

                                        $http.post(GROXER_API_LINK+"?action=logout",
                                        {
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        ...
                        files: [
                            ...
                            'metronic/theme/assets/global/plugins/jquery.sparkline.min.js',
